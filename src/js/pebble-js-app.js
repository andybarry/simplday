...
function locationSuccess(pos) {
  ...
  var d = new Date();
  var sunTimes = SunCalc.getTimes(d, coordinates.latitude, coordinates.longitude);
  var sunsetStr = sunTimes.sunset.getHours() + ':' + sunTimes.sunset.getMinutes(); 
  var sunriseStr = sunTimes.sunrise.getHours() + ':' + sunTimes.sunrise.getMinutes(); 
  console.log(sunsetStr);
  console.log(sunriseStr);
  Pebble.sendAppMessage({ "sunset_time":sunTimes.sunset.getHours()*60+sunTimes.sunset.getMinutes(), "sunrise_time":sunTimes.sunrise.getHours()*60+sunTimes.sunrise.getMinutes()});            
}

function locationError(err) {
  console.warn('location error (' + err.code + '): ' + err.message);
  //Pebble.sendAppMessage({ "city":"Sun times unavailable" });
}
